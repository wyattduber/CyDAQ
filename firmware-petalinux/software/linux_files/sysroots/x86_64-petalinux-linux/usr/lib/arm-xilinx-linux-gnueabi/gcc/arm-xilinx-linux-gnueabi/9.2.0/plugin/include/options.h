...
enum opt_code
{
  ...
  OPT_mandroid = 1277,                       /* -mandroid */
  OPT_mapcs = 1278,                          /* -mapcs */
  OPT_mapcs_frame = 1279,                    /* -mapcs-frame */
  OPT_mapcs_reentrant = 1280,                /* -mapcs-reentrant */
  OPT_mapcs_stack_check = 1281,              /* -mapcs-stack-check */
  OPT_march_ = 1282,                         /* -march= */
  OPT_marm = 1283,                           /* -marm */
  OPT_masm_syntax_unified = 1284,            /* -masm-syntax-unified */
  OPT_mbe32 = 1285,                          /* -mbe32 */
  OPT_mbe8 = 1286,                           /* -mbe8 */
  OPT_mbig_endian = 1287,                    /* -mbig-endian */
  OPT_mbionic = 1288,                        /* -mbionic */
  OPT_mbranch_cost_ = 1289,                  /* -mbranch-cost= */
  OPT_mcallee_super_interworking = 1290,     /* -mcallee-super-interworking */
  OPT_mcaller_super_interworking = 1291,     /* -mcaller-super-interworking */
  OPT_mcmse = 1292,                          /* -mcmse */
  OPT_mcpu_ = 1293,                          /* -mcpu= */
  OPT_mfix_cortex_m3_ldrd = 1294,            /* -mfix-cortex-m3-ldrd */
  OPT_mflip_thumb = 1295,                    /* -mflip-thumb */
  OPT_mfloat_abi_ = 1296,                    /* -mfloat-abi= */
  OPT_mfp16_format_ = 1297,                  /* -mfp16-format= */
  OPT_mfpu_ = 1298,                          /* -mfpu= */
  OPT_mgeneral_regs_only = 1299,             /* -mgeneral-regs-only */
  OPT_mglibc = 1300,                         /* -mglibc */
  /* OPT_mhard_float = 1301, */              /* -mhard-float */
  OPT_mlittle_endian = 1302,                 /* -mlittle-endian */
  OPT_mlong_calls = 1303,                    /* -mlong-calls */
  OPT_mmusl = 1304,                          /* -mmusl */
  OPT_mneon_for_64bits = 1305,               /* -mneon-for-64bits */
  OPT_mpic_data_is_text_relative = 1306,     /* -mpic-data-is-text-relative */
  OPT_mpic_register_ = 1307,                 /* -mpic-register= */
  OPT_mpoke_function_name = 1308,            /* -mpoke-function-name */
  OPT_mprint_tune_info = 1309,               /* -mprint-tune-info */
  OPT_mpure_code = 1310,                     /* -mpure-code */
  OPT_mrestrict_it = 1311,                   /* -mrestrict-it */
  OPT_msched_prolog = 1312,                  /* -msched-prolog */
  OPT_msingle_pic_base = 1313,               /* -msingle-pic-base */
  OPT_mslow_flash_data = 1314,               /* -mslow-flash-data */
  /* OPT_msoft_float = 1315, */              /* -msoft-float */
  OPT_mstructure_size_boundary_ = 1316,      /* -mstructure-size-boundary= */
  OPT_mthumb = 1317,                         /* -mthumb */
  OPT_mthumb_interwork = 1318,               /* -mthumb-interwork */
  OPT_mtls_dialect_ = 1319,                  /* -mtls-dialect= */
  OPT_mtp_ = 1320,                           /* -mtp= */
  OPT_mtpcs_frame = 1321,                    /* -mtpcs-frame */
  OPT_mtpcs_leaf_frame = 1322,               /* -mtpcs-leaf-frame */
  OPT_mtune_ = 1323,                         /* -mtune= */
  OPT_muclibc = 1324,                        /* -muclibc */
  OPT_munaligned_access = 1325,              /* -munaligned-access */
  OPT_mvectorize_with_neon_double = 1326,    /* -mvectorize-with-neon-double */
  OPT_mvectorize_with_neon_quad = 1327,      /* -mvectorize-with-neon-quad */
  OPT_mverbose_cost_dump = 1328,             /* -mverbose-cost-dump */
  OPT_mword_relocations = 1329,              /* -mword-relocations */
  OPT_n = 1330,                              /* -n */
  OPT_no_canonical_prefixes = 1331,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1332,              /* -no-integrated-cpp */
  OPT_no_pie = 1333,                         /* -no-pie */
  OPT_nocpp = 1334,                          /* -nocpp */
  OPT_nodefaultlibs = 1335,                  /* -nodefaultlibs */
  OPT_nolibc = 1336,                         /* -nolibc */
  OPT_nophoboslib = 1337,                    /* -nophoboslib */
  OPT_nostartfiles = 1338,                   /* -nostartfiles */
  OPT_nostdinc = 1339,                       /* -nostdinc */
  OPT_nostdinc__ = 1340,                     /* -nostdinc++ */
  OPT_nostdlib = 1341,                       /* -nostdlib */
  OPT_nostdlib__ = 1342,                     /* -nostdlib++ */
  OPT_o = 1343,                              /* -o */
  OPT_p = 1344,                              /* -p */
  OPT_pass_exit_codes = 1345,                /* -pass-exit-codes */
  /* OPT_pedantic = 1346, */                 /* -pedantic */
  OPT_pedantic_errors = 1347,                /* -pedantic-errors */
  OPT_pg = 1348,                             /* -pg */
  OPT_pie = 1349,                            /* -pie */
  OPT_pipe = 1350,                           /* -pipe */
  OPT_posix = 1351,                          /* -posix */
  OPT_print_file_name_ = 1352,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1353,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1354,          /* -print-multi-directory */
  OPT_print_multi_lib = 1355,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1356,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1357,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1358,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1359,               /* -print-prog-name= */
  OPT_print_search_dirs = 1360,              /* -print-search-dirs */
  OPT_print_sysroot = 1361,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1362,   /* -print-sysroot-headers-suffix */
  OPT_profile = 1363,                        /* -profile */
  OPT_pthread = 1364,                        /* -pthread */
  OPT_quiet = 1365,                          /* -quiet */
  OPT_r = 1366,                              /* -r */
  OPT_rdynamic = 1367,                       /* -rdynamic */
  OPT_remap = 1368,                          /* -remap */
  OPT_s = 1369,                              /* -s */
  OPT_save_temps = 1370,                     /* -save-temps */
  OPT_save_temps_ = 1371,                    /* -save-temps= */
  OPT_shared = 1372,                         /* -shared */
  OPT_shared_libgcc = 1373,                  /* -shared-libgcc */
  OPT_shared_libphobos = 1374,               /* -shared-libphobos */
  /* OPT_specs = 1375, */                    /* -specs */
  OPT_specs_ = 1376,                         /* -specs= */
  OPT_static = 1377,                         /* -static */
  OPT_static_libasan = 1378,                 /* -static-libasan */
  OPT_static_libgcc = 1379,                  /* -static-libgcc */
  ...
  OPT_static_libphobos = 1385,               /* -static-libphobos */
  OPT_static_libstdc__ = 1386,               /* -static-libstdc++ */
  OPT_static_libtsan = 1387,                 /* -static-libtsan */
  OPT_static_libubsan = 1388,                /* -static-libubsan */
  OPT_static_pie = 1389,                     /* -static-pie */
  /* OPT_std_c__03 = 1390, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1391, */                /* -std=c++0x */
  OPT_std_c__11 = 1392,                      /* -std=c++11 */
  OPT_std_c__14 = 1393,                      /* -std=c++14 */
  OPT_std_c__17 = 1394,                      /* -std=c++17 */
  /* OPT_std_c__1y = 1395, */                /* -std=c++1y */
  /* OPT_std_c__1z = 1396, */                /* -std=c++1z */
  OPT_std_c__2a = 1397,                      /* -std=c++2a */
  OPT_std_c__98 = 1398,                      /* -std=c++98 */
  OPT_std_c11 = 1399,                        /* -std=c11 */
  OPT_std_c17 = 1400,                        /* -std=c17 */
  /* OPT_std_c18 = 1401, */                  /* -std=c18 */
  /* OPT_std_c1x = 1402, */                  /* -std=c1x */
  OPT_std_c2x = 1403,                        /* -std=c2x */
  /* OPT_std_c89 = 1404, */                  /* -std=c89 */
  OPT_std_c90 = 1405,                        /* -std=c90 */
  OPT_std_c99 = 1406,                        /* -std=c99 */
  /* OPT_std_c9x = 1407, */                  /* -std=c9x */
  OPT_std_f2003 = 1408,                      /* -std=f2003 */
  OPT_std_f2008 = 1409,                      /* -std=f2008 */
  OPT_std_f2008ts = 1410,                    /* -std=f2008ts */
  OPT_std_f2018 = 1411,                      /* -std=f2018 */
  OPT_std_f95 = 1412,                        /* -std=f95 */
  OPT_std_gnu = 1413,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1414, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1415, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1416,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1417,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 1418,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1419, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 1420, */              /* -std=gnu++1z */
  OPT_std_gnu__2a = 1421,                    /* -std=gnu++2a */
  OPT_std_gnu__98 = 1422,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1423,                      /* -std=gnu11 */
  OPT_std_gnu17 = 1424,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 1425, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 1426, */                /* -std=gnu1x */
  OPT_std_gnu2x = 1427,                      /* -std=gnu2x */
  /* OPT_std_gnu89 = 1428, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1429,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1430,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1431, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1432, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1433,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1434, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1435, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1436, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 1437, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 1438, */         /* -std=iso9899:2018 */
  OPT_std_legacy = 1439,                     /* -std=legacy */
  OPT_symbolic = 1440,                       /* -symbolic */
  OPT_t = 1441,                              /* -t */
  OPT_time = 1442,                           /* -time */
  OPT_time_ = 1443,                          /* -time= */
  OPT_tno_android_cc = 1444,                 /* -tno-android-cc */
  OPT_tno_android_ld = 1445,                 /* -tno-android-ld */
  OPT_traditional = 1446,                    /* -traditional */
  OPT_traditional_cpp = 1447,                /* -traditional-cpp */
  OPT_trigraphs = 1448,                      /* -trigraphs */
  OPT_u = 1449,                              /* -u */
  OPT_undef = 1450,                          /* -undef */
  OPT_v = 1451,                              /* -v */
  OPT_version = 1452,                        /* -version */
  OPT_w = 1453,                              /* -w */
  OPT_wrapper = 1454,                        /* -wrapper */
  OPT_x = 1455,                              /* -x */
  OPT_z = 1456,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
