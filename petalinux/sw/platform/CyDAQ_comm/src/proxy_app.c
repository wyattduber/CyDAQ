...
char *rpmsg_svc="rpmsg-openamp-demo-channel"; //TDOO change name?
int rpmsg_char_fd = -1;
int ept_fd = -1;
...
/*
 * TODO write more
 * Start the remoteproc and listen/handle incomming messages from it
 * Blocking
 */
int rpc_init_listen(){
	...
	strcpy(eptinfo.name, "rpmsg-openamp-demo-channel"); //TODO change name
	eptinfo.src = 0;
