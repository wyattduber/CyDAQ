...
HD_PWD='U:/sdmay23-47/petalinux/hw/hw/hw.runs/system_axi_gpio_eth_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_axi_gpio_eth_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_axi_gpio_eth_0.tcl
