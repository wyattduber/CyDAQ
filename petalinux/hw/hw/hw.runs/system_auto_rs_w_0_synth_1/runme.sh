...
HD_PWD='U:/sdmay23-47/petalinux/hw/hw/hw.runs/system_auto_rs_w_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_auto_rs_w_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_auto_rs_w_0.tcl
