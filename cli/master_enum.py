...
parameter_dict = {
    ...
    "Inputs" : {
        "Options" : ["5 volt", "3.3 volt", "1.8 volt", "Analog In", "Audio In", "Digital I2C Bus", "Digital SPI Bus", "Digital UART"],
        "Children" : {
    ...
    "Analog Filter" : {
        "Options" : ["All Pass", "60 hz Notch", "1st Order High Pass", "1st Order Low Pass", "6th Order High Pass", "6th Order Low Pass", "2nd Order Band Pass", "6th Order Band Pass"],
        "Children" : {
            "All Pass": None,
            "60 hz Notch": None,
