...
"")
        ...
        self.low_corner_min_btn_2 = QtWidgets.QPushButton(self.centralwidget)
        self.low_corner_min_btn_2.setObjectName("low_corner_min_btn_2")
        self.high_corner_bar_layout.addWidget(self.low_corner_min_btn_2)
        self.label_4 = QtWidgets.QLabel(self.centralwidget)
        self.label_4.setObjectName("label_4")
        self.high_corner_bar_layout.addWidget(self.label_4)
        self.high_corner_bar_input = QtWidgets.QLineEdit(self.centralwidget)
        self.high_corner_bar_input.setObjectName("high_corner_bar_input")
        self.high_corner_bar_layout.addWidget(self.high_corner_bar_input)
        self.label_5 = QtWidgets.QLabel(self.centralwidget)
        self.label_5.setObjectName("label_5")
        self.high_corner_bar_layout.addWidget(self.label_5)
        self.low_corner_max_btn_2 = QtWidgets.QPushButton(self.centralwidget)
        self.low_corner_max_btn_2.setObjectName("low_corner_max_btn_2")
        self.high_corner_bar_layout.addWidget(self.low_corner_max_btn_2)
    ...
    def retranslateUi(self, basic_operation):
        ...
        self.filter_input_box.setItemText(1, _translate("basic_operation", "60Hz Notch"))
        ...
        self.low_corner_min_btn_2.setText(_translate("basic_operation", "2,000"))
        self.label_4.setText(_translate("basic_operation", "≤"))
        self.label_5.setText(_translate("basic_operation", "≤"))
        self.low_corner_max_btn_2.setText(_translate("basic_operation", "40,000"))
