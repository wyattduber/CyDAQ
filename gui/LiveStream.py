...
"}")
        ...
        self.verticalLayout_3.addWidget(self.infile_line)
        ...
        self.verticalLayout_3.addWidget(self.speed_line)
        self.speed_wl = QtWidgets.QLabel(self.centralwidget)
        self.speed_wl.setMaximumSize(QtCore.QSize(16777215, 50))
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
        font.setPointSize(-1)
        ...
        self.verticalLayout_3.addWidget(self.speed_wl)
