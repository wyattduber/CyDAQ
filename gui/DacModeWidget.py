...
class Ui_DAC_mode_widget(object):
    def setupUi(self, DAC_mode_widget):
        ...
        self.repetitions_input_2 = QtWidgets.QLineEdit(self.layoutWidget)
        self.repetitions_input_2.setObjectName("repetitions_input_2")
        self.horizontalLayout_2.addWidget(self.repetitions_input_2)
