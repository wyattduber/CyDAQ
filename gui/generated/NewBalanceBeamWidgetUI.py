...
"background-color: #d9d9d9;")
        ...
        self.graph = QtWidgets.QWidget(NewBalanceBeamWidget)
        self.graph.setGeometry(QtCore.QRect(340, 30, 801, 641))
        self.graph.setMaximumSize(QtCore.QSize(16777215, 16777215))
        self.graph.setObjectName("graph")
        self.horizontalLayoutWidget_3 = QtWidgets.QWidget(NewBalanceBeamWidget)
    ...
    def retranslateUi(self, NewBalanceBeamWidget):
        ...
        self.start_btn.setText(_translate("NewBalanceBeamWidget", "Start"))
        self.pushButton.setText(_translate("NewBalanceBeamWidget", "Stop"))
