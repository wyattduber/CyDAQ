...
"}")
    ...
    def retranslateUi(self, BasicOpetaionWidget):
        ...
        self.input_input_box.setItemText(2, _translate("BasicOpetaionWidget", "1.8 Volt"))
        self.input_input_box.setItemText(3, _translate("BasicOpetaionWidget", "Analog In"))
        self.input_input_box.setItemText(4, _translate("BasicOpetaionWidget", "Audio In"))
        self.input_input_box.setItemText(5, _translate("BasicOpetaionWidget", "Digital I2C Bus"))
        self.input_input_box.setItemText(6, _translate("BasicOpetaionWidget", "Digital SPI Bus"))
        self.input_input_box.setItemText(7, _translate("BasicOpetaionWidget", "Digital UART"))
