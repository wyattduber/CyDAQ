...
"}")
        ...
        self.horizontalLayout_3.addWidget(self.clear_log_btn)
        self.wrapper.addLayout(self.horizontalLayout_3)
        ...
        self.export_logs_btn = QtWidgets.QPushButton(self.centralwidget)
    ...
    def retranslateUi(self, debug):
        ...
        self.clear_log_btn.setText(_translate("debug", "Clear"))
        ...
        self.export_logs_btn.setText(_translate("debug", "Export Logs -->"))
